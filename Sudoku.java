...
public class Sudoku {    
    ...
    /*
     * checks all 9 x 9 if a specific number is already in the same column 
     */
    private boolean [][] inVert; 
    /*
     * checks 9 x 9 if specific number in same row 
     */
    private boolean [][] inHor;  
    /* 
    ...
    public Sudoku() {
        ...
        this.inVert = new boolean [9][10]; 
        this.inHor = new boolean [9][10];
    }
    ...
    public void placeVal(int val, int row, int col) {
        ...
        this.inVert[row][val] = true; 
        this.inHor[col][val] = true; 
    ...
    public void removeVal(int val, int row, int col) {
        ...
        /*** UPDATE YOUR ADDITIONAL FIELDS HERE. ***/
        this.inVert[row][val] = false; 
        this.inHor[col][val] = false; 
    ...
    private boolean solveRB(int n) {
    	...
    	for(int i = 1;i < 10; i++) {//check each row in full grid 
    		if(this.inVert[row][i] == false && this.subgridHasVal[row/3][col/3][i] == false && this.inHor[col][i] == false) {
    			placeVal(i,row,col); 
    			if(solveRB(n + 1) == true) 
    				{
    				return true;
